// src/components/produtos/PDVPagamentoModal.jsx
import { useState } from 'react';
import Modal from '../Modal';
import { CreditCard, DollarSign, Smartphone, Building } from 'lucide-react';

const PDVPagamentoModal = ({ isOpen, onClose, onConfirm, total }) => {
    ...
    >
      <div className="space-y-6">
        ...
        <div className="bg-gradient-to-r from-green-600 to-emerald-600 text-white rounded-lg p-6 text-center">
          <p className="text-sm opacity-90 mb-2">Valor Total da Venda</p>
...
export default PDVPagamentoModal;